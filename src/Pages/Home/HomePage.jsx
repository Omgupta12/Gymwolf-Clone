...
import Lifted from "../Lifted/Lifted";
      ...
      <Box>
        ...
        <Box className="home_personal-trainer-main-box">
          <Box className="home_personal-trainer-left">
            ...
            >
              <Box className="home_personal-trainer-heading">
                {" "}
                <Heading>Online personal trainer</Heading>
              </Box>
              <Box className="home_personal-trainer-para">
                {" "}
                <Text>
                  ...
                  track your progress, coach and motivate you daily through our
        ...
        <Box className="home_features-main-box">
          <Box className="home_features-left">
            ...
            >
              <Box className="home_features-heading">
                {" "}
                <Heading>Features</Heading>
              </Box>
              <Box className="home_features-para">
                {" "}
                <Text>
        ...
        <Box className="home_progress-main-box">
          <Box className="home_progress-left">
            ...
            >
              <Box className="home_progress-heading">
                {" "}
                <Heading>See your progress</Heading>
              </Box>
              <Box className="home_progress-para">
                {" "}
                <Text>
                  Gymwolf provides different graphs that help you track your
                  progress. There are graphs for gym workouts, cardio workouts
                  and bodyweight. The graphs are highly customizable: you can
                  select the date range, exercise and group the results by
                  month, week or single workout.
                </Text>
              </Box>
              <Button
                colorScheme="white"
        ...
        <Box className="home_database-main-box">
          <Box className="home_database-left">
            ...
            >
              <Box className="home_database-heading">
                {" "}
                <Heading>Database with 300+ exercises</Heading>
              </Box>
              <Box className="home_database-para">
                {" "}
                <Text>
